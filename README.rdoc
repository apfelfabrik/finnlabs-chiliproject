...
<em>Finnlabs continues ChiliProject development in a fork named OpenProject. See https://github.com/opf/openproject and https://openproject.org. Please create pull requests against our OpenProject repository.</em>
